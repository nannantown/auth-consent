export const translations = {
  ja: {
    ...
    habits: {
      ...
      habitName: '習慣名',
      habitNamePlaceholder: '例: 朝起きたらストレッチする',
      chapter: 'カテゴリ',
      frequency: '頻度',
      principle: '習慣化の原理',
      evidence: '科学的根拠',
      evidencePlaceholder: 'この習慣が効果的な理由（任意）',
      trigger: 'トリガー',
      triggerPlaceholder: 'いつ・どんな時にやるか（任意）',
      active: '実行中',
      paused: '休止中',
      streak: '連続',
      days: '日',
      ...
      undo: '取り消し',
      noHabits: '習慣がまだありません',
      noHabitsDescription: '科学的に証明されたテクニックで、習慣を始めましょう',
      allChapters: 'すべて',
      principles: '3つの原理',
      principlesSubtitle: '「すごい習慣大百科」の科学的習慣化原理',
      save: '保存',
      cancel: 'キャンセル',
      completedToday: '今日達成',
      totalHabits: '習慣数',
  ...
  en: {
    ...
    habits: {
      ...
      habitNamePlaceholder: 'e.g. Stretch after waking up',
      chapter: 'Category',
      frequency: 'Frequency',
      principle: 'Habit Principle',
      evidence: 'Scientific Evidence',
      evidencePlaceholder: 'Why this habit works (optional)',
      trigger: 'Trigger',
      triggerPlaceholder: 'When to do it (optional)',
      active: 'Active',
      paused: 'Paused',
      streak: 'Streak',
      days: 'days',
      ...
      noHabitsDescription: 'Start building habits with science-backed techniques',
      allChapters: 'All',
      principles: '3 Principles',
      principlesSubtitle: 'Scientific habit formation from "Amazing Habits Encyclopedia"',
      save: 'Save',
      cancel: 'Cancel',
