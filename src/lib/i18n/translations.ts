export const translations = {
  ja: {
    ...
    dashboard: {
      ...
      greetingSubtitle: 'あなたのデータを管理しましょう',
      addSpace: 'スペースを追加',
    ...
    goals: {
      ...
      habitTracker: {
        ...
        editHabit: '習慣を編集',
        deleteHabit: '習慣を削除',
        deleteConfirm: 'この習慣を削除しますか？この操作は取り消せません。',
        emptyTitle: '習慣を始めよう',
        emptyDescription: '毎日の習慣をトラッキングしてストリークを伸ばそう',
        emptyAction: '最初の習慣を追加',
        todayHabits: '今日の習慣',
        allHabits: 'すべての習慣',
        currentStreak: '連続日数',
        bestStreak: '最長記録',
        completionRate: '完了率',
        habitName: '習慣名',
        habitNamePlaceholder: '例: 朝のランニング',
        frequency: '頻度',
        daily: '毎日',
        weekly: '毎週',
        targetCount: '目標回数',
    ...
    health: {
      ...
      emptyTitle: '健康記録を始めよう',
      emptyDescription: '最初の記録を追加して健康管理を始めましょう',
      metricType: '指標',
      value: '値',
      unit: '単位',
      date: '日付',
      title: 'タイトル（任意）',
      titlePlaceholder: '空欄の場合は自動生成',
      notes: 'メモ',
      save: '保存',
      cancel: 'キャンセル',
      delete: '削除',
    ...
    career: {
      ...
      tabSkills: 'スキル',
      skillRadar: 'スキルレーダー',
      avgProficiency: '平均習熟度',
      skills: 'スキル',
      addSkill: '追加',
      editSkill: '編集',
      deleteSkill: '削除',
      deleteSkillConfirm: 'このスキルを削除しますか？この操作は取り消せません。',
      noSkills: 'スキルがまだありません',
      addFirstSkill: '最初のスキルを追加',
      minCategoriesMessage: '3つ以上のカテゴリにスキルを追加するとレーダーチャートが表示されます',
      categories: {
        Programming: 'プログラミング',
        Language: '言語',
        Management: 'マネジメント',
  ...
  en: {
    ...
    dashboard: {
      title: 'Dashboard',
      greeting: 'Hi, {name}!',
      greetingSubtitle: 'Manage your personal data',
      addSpace: 'Add Space',
    ...
    goals: {
      ...
      habitTracker: {
        ...
        deleteConfirm: 'Delete this habit? This cannot be undone.',
        emptyTitle: 'Start building habits',
        emptyDescription: 'Track your daily habits and build streaks',
    ...
    health: {
      ...
      emptyTitle: 'Start tracking your health',
      emptyDescription: 'Add your first record to begin health tracking',
    ...
    career: {
      ...
      minCategoriesMessage: 'Add skills in at least 3 categories to see the skill radar',
      categories: {
